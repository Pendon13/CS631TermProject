...
$appt_query = "SELECT * FROM `appointment`, `invoicedetails`, `businesslocation` WHERE invoicedetails.appt_id = appointment.id AND appointment.loc_id = businesslocation.id AND `appt_date` = \"$requesteddate\" AND `loc_address` = \"$location\"";
